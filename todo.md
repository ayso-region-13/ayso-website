...
- [ ] **Expand SportsOrganization `sameAs` array** — now includes `https://www.ayso.org` and the Google Maps Place URL for Region 13's GBP (cid `9491143221518550898`, added 2026-05-23). Still pending: Facebook / Instagram URLs if Region 13 has social accounts. Strengthens entity disambiguation in Knowledge Graph.
