...
- [x] **Promoted to prod** — all 10 staging commits (Pagefind + brand-gold + WP archive + fields/index + map-overview + the CF Pages workaround chain) shipped via `gh workflow run "Promote Staging to Production"`. Verified on www.ayso13.org: 7/7 changed endpoints serve 200, all 3 page content updates visible.
