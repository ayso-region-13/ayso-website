...
---
*Last updated: 2026-08-31 — session 51 (PostHog installed alongside GA4, production-only; csp-report now drops the doubleclick noise, which turned out to come from our own GA4 tag).*
