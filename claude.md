...
---
*Last updated: 2026-05-23 (session 29 — Social: IG + FB linked across schema sameAs, footer icons, /contact/, /about/, /resources/newsletters/, llms.txt; IFAB links repointed to edition-agnostic index + annual IFAB todo retired; KFPM penalty-kick PDF ingested; la-salle + marshall duplicate Google-embed maps removed; daily 404 + CSP sweeps)*
