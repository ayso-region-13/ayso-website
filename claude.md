...
---
*Last updated: 2026-05-23 (session 29 — Social: IG + FB linked across schema sameAs, footer icons, /contact/, /about/, /resources/newsletters/, llms.txt; IFAB links repointed to edition-agnostic index + annual IFAB todo retired; KFPM penalty-kick PDF ingested; la-salle + marshall duplicate Google-embed maps removed; GSC 28d review + 4 quick-win SERP optimizations: Ask-the-Referee title/desc rewrite, geo coords on all 23 field pages, soccer-shootout title, /about/ title; daily 404 + CSP sweeps)*
