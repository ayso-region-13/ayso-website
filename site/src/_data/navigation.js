module.exports = [
...

  {
    ...
    children: [
      ...
      { label: "EXTRA (10U Select)",       url: "/programs/extra/" },
      ...
      { label: "Rose City Cup",            url: "/programs/tournaments/rose-city-cup/", divider: true, dividerLabel: "Tournaments" },
      { label: "Thanksgiving Tournament",  url: "/programs/tournaments/thanksgiving/" },
    ],
  },
...

  {
    ...
    children: [
      ...
      { label: "Blair Lower",            url: "/fields/blair-lower/" },
      { label: "Blair Upper",            url: "/fields/blair-upper/" },
      ...
      { label: "Gwinn Park",            url: "/fields/gwinn/" },
      { label: "Jefferson Park",        url: "/fields/jefferson/" },
      { label: "La Cañada Elementary",  url: "/fields/la-canada-elementary/" },
      { label: "La Cañada High School", url: "/fields/lchs/" },
      { label: "La Salle High School",  url: "/fields/la-salle/" },
      { label: "LC LDS",                url: "/fields/lc-lds/" },
      { label: "Marshall Secondary",    url: "/fields/marshall/" },
...

  {
    ...
    children: [
      ...
      { label: "Silent Saturday",             url: "/families/silent-saturday/" },
