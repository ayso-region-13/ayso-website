...
4. [Region 13 Policies and Procedures](/assets/docs/region-13-policies-protocols.pdf) — covers the [refund schedule](/register/#refunds-and-withdrawals), conduct standards, and local addendums
...
### Concussion Protocol
- All players and families receive CDC concussion information (available in English and Spanish). The acknowledgment families sign is in [Concussion & SCA Forms (PDF)](/assets/docs/concussion-sca-forms.pdf)
- Volunteers complete CDC Concussion Awareness training through [eTrainU](/volunteers/classes/)
...
Warning signs, the removal steps, and the return-to-play clearance are on [Safety](/resources/safety/).

### Sudden Cardiac Arrest
- Information sheets provided to all families, in [Concussion & SCA Forms (PDF)](/assets/docs/concussion-sca-forms.pdf)
- Volunteers complete Simon's Heart SCA training through [eTrainU](/volunteers/classes/)
- Players showing symptoms are removed from play immediately and must receive professional medical evaluation

Warning signs and risk factors are on [Safety](/resources/safety/).

## Field Rules

### Turf Fields
Only water is permitted on turf fields. No sports drinks, food, or gum. Only players, coaches, and referees are allowed on the field or benches.

### No Pets
Pets are not allowed at any AYSO events in the region. Service animals are exempt.

Rules that vary by site, including parking and turf restrictions, are on each [field page](/fields/).

## Equipment

### Jewelry
Earrings and other jewelry must be removed to play soccer. This is a [Law of the Game](/referees/laws/) and applies to all practices and games. Earrings cannot be taped over.
...
Coaches initial game cards confirming they understand this policy. See the full [Respect the Referee policy (PDF)](/assets/docs/respect-the-referee.pdf) for details, and [Respecting Our Referees (2026) (PDF)](/assets/docs/respecting-our-referees-2026.pdf) for AYSO's current standards, abuse levels, and consequences.
...
For concerns about conduct or policy violations, use the incident reporting process. See [Safety](/resources/safety/) for the steps and the forms.

- Conduct or safety incidents: [Incident Reporting](/contact/feedback/)
- Abuse of a referee: [Referee Abuse Prevention](/referees/abuse/), which is handled by Area 1C rather than by Region 13
