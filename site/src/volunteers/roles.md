...
The Secretary attends the Regional Board meetings and records [board meeting minutes](https://ayso13.org/minutes/). They distribute those minutes to the board members for approval and distribution. All board meeting minutes are publicly available.
...
The EPIC Coordinator organizes and executes our [EPIC program](https://ayso.org/epic/). EPIC is an AYSO National effort which provides soccer programs to children with disabilities. It helps them to enjoy the beautiful game to the fullest extent, in an environment guided by AYSO’s six Philosophies. The EPIC Coordinator communicates with families, recruits buddies, and provides a Saturday afternoon program, usually at Victory Park. Our EPIC program also frequently participates in EPIC activities with other nearby Regions.
