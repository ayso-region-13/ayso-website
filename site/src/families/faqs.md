...
description: Frequently asked questions for Region 13 families — registration,
  schedules, refunds, uniforms, volunteering, and more.
layout: page.njk
section: families
---
## Registration
...
Sometimes, if space is available. Contact [registrar@ayso13.org](mailto:registrar@ayso13.org).
...
### Can my child play with their friend? My child is on a different team than their friend even though we requested each other. Why?

In Preschool and Friendly Divisions (4U-8U) you may request to play with buddies. We try our best to honor requests when possible but cannot guarantee them. It is more likely a request is able to be honored when the player is accompanied by a coach or referee volunteer. In 10U+, we do not accept pairing requests with friends – the only pairing requests considered are between a Head Coach and one Referee. Those requests may be honored if the pairing does not impact our ability to balance teams.
...
Other roles include team manager, field host, and snack coordinator. See [Volunteer Roles](/volunteers/roles).
...
Any player who shows signs of a concussion is removed from play immediately and cannot return until cleared by a medical professional. See our [Safety page](/resources/safety/).
...
2. Confirm your email is correct in your [your InLeague profile](https://ayso13.inleague.com/app/family-profile)
3. Contact [team@ayso13.org](mailto:team@ayso13.org) if you're still not receiving messages

### How do I contact my coach?

Your coach's contact info is in your team assignment email and in [InLeague](https://ayso13.inleague.com/app)
...
| Issue | Contact |
| ---------------------------- | --------------------------------------------------- |
| Registration, team placement | [registrar@ayso13.org](mailto:registrar@ayso13.org) |
| Team communication | [team@ayso13.org](mailto:team@ayso13.org) |
| Practice fields | [practice@ayso13.org](mailto:practice@ayso13.org) |
