...
layout: page.njk
section: resources
description: "AYSO Region 13 wet-field policy. Field owners have final say on closures; Region 13 thresholds are the earliest point at which we close on our own."
---
...
Live readings and the current 48-hour / 72-hour rainfall totals are on the [Weather and Field Conditions](/resources/weather/) page.
...
Rainfall is measured at Region 13's on-site Tempest weather station and updated every five minutes. The [Weather and Field Conditions](/resources/weather/) page shows the running 48-hour and 72-hour totals along with current conditions; when a threshold is crossed, a closure banner appears at the top of the page automatically.
