...
- 11 = Best player in the division
- 5 = Average for the division
...
### Rating
Follow the Player Assessment Guidelines (auto-calculate ratings based on your observations).

### Notes
Document strengths and weaknesses. Example:
"Strong ball control and dribbling skills, but needs to develop passing awareness. Dominant right-foot technique but reluctant to use left foot."
...
2. List player names and jersey numbers
3. Follow assessment guidelines for each player
